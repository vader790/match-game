...
function incrementCounter(counterName, parentElement) {
  ...
  parentElement.textContent = counters[counterName];
}
...
function onCardFlipped(newlyFlippedCard) {
  ...
  incrementCounter("flipCount", document.querySelector("#flip-count"));
  ...
  incrementCounter("matchCount", document.querySelector("#match-count"));
...
function resetGame() {
  ...
  let cardElement = document.querySelector("#card-container");
  ...
  document.querySelector("#flip-count").textContent = 0;
  document.querySelector("#match-count").textContent = 0;
